...
export const imbalanceRecordSchema = Joi.object({
	imbalance_record_id: idFieldSchema,
	fv_imbalance_record_id: Joi.number().integer().required(),
	imbalance_record_time: timestampSchema.required(),

	// data
	imbalance_metric: Joi.number().integer().required(),
	faction_1_id: Joi.number().integer().required(),
	faction_2_id: Joi.number().integer().required(),
	imbalance_record_value: Joi.number().required(),
	imbalance_record_value_text: shortTextStringSchema.required(),
